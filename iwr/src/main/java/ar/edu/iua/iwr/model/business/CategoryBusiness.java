...
import ar.edu.iua.iwr.model.persistence.CategoryRepository;
import lombok.extern.slf4j.Slf4j;

@Service //candidato de instanciacion del servicio de negorcio cuando necesitemos algo de icategory business
@Slf4j
public class CategoryBusiness implements ICategoryBusiness {
	@Autowired //se instancie automaticamnet
