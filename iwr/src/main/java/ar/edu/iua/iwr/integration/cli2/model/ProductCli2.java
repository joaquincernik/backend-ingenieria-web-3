...
public class ProductCli2 extends Product{
	...
	@ManyToMany(fetch = FetchType.EAGER) //fetch es la forma que va a usar los datos extra que acarrea la product principal
	//cuando te pido un producto, te cargo todos los componentes?
	//eager los trae cada vez que carge
	@JoinTable(name = "cli2_product_component", //tabla que se genera en medio de dos tablas, cli2products y components
	...
	//para que no permita duplicados
